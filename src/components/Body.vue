                ...
                <div class="container">
                    <div class="slider-container has-scrollbar">
                        <div class="slider-item">
                            <img src="../../assets/images/banner-1.jpg" alt="women's latest fashion sale"
                                class="banner-img" />
                        ...
                        <div class="slider-item">
                            <img src="../../assets/images/banner-3.jpg" alt="new fashion summer sale"
                                class="banner-img" />
                ...
                <div class="container">
                    ...
                    <div class="product-box">
                        ...
                        <div class="product-main">
                            ...
                            <div class="product-grid" id="app">
                                <router-link v-for="(item, index) in product_list" :key="index"
                                    :to="`/product/${item.id}`" class="showcase">
                                    <div class="showcase-banner">
                                        <img :src="item.image" alt="Mens Winter Leathers Jackets" width="300"
                                            style="width: 100%; height: 300px; object-fit:contain"
                                            class="product-img default" />
                                        <img :src="item.image" alt="Mens Winter Leathers Jackets" width="300"
                                            class="product-img hover" />

                                        <p class="showcase-badge">{{ item.rating.count }}</p>
                                    ...
                                    <div class="showcase-content">
                                        ...
                                        <a href="#">
                                            <h3 class="showcase-title" style="white-space: nowrap;">{{
                                                truncateWords(item.title) }}</h3>
                                        </a>
                    ...
                    <ion-icon name="star-outline"></ion-icon>
                                        ...
                                        <div class="showcase-rating">
                                            <ion-icon v-for="n in 5" :key="n"
                                                :name="n <= Math.round(item.rating.rate) ? 'star' : 'star-outline'"></ion-icon>
                                        </div>
                                        <div class="price-box">
                                            <p class="price">${{ round(item.price * 0.85, 2) }}</p>
                                            <del>${{ item.price }}</del>
                                        </div>
                                    </div>
                                </router-link>
                    ...
                    <div class="blog-container has-scrollbar">
                        <div class="blog-card">
                            ...
                            <div class="blog-content">
                                ...
                                <p class="blog-meta">By <cite>Mr Admin</cite> / <time datetime="2024-04-06">Apr 06,
                                        2024</time></p>
                            </div>
                        </div>
                        ...
                        <div class="blog-card">
                            ...
                            <div class="blog-content">
                                ...
                                <p class="blog-meta">By <cite>Mr Robin</cite> / <time datetime="2024-01-18">Jan 18,
                                        2024</time></p>
                            </div>
                        </div>
                        ...
                        <div class="blog-card">
                            ...
                            <div class="blog-content">
                                ...
                                <p class="blog-meta">By <cite>Mr Selsa</cite> / <time datetime="2024-02-10">Feb 10,
                                        2024</time></p>
                            </div>
                        </div>
                        ...
                        <div class="blog-card">
                            ...
                            <div class="blog-content">
                                ...
                                <p class="blog-meta">By <cite>Mr Pawar</cite> / <time datetime="2024-03-15">Mar 15,
                                        2024</time></p>
                            </div>
                        </div>
                    </div>
